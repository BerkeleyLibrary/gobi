...
describe GOBI do
  ...
  let(:processed_DEG_file) { "./data/gobi_processed/ebookDEG#{Date.today.year}0223.ord" }
  let(:processed_EBS_file) { "./data/gobi_processed/ebookEBS#{Date.today.year}0223.ord" }
